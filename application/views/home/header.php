        ...
        <div class="header-top">
            <div class="container">
                ...
                <div class="ht-right">
                    ...
                    if ($user) {
                        echo '
                        <a href="' . base_url("auth/logout") . '" class="login-panel"><i class="fa fa-user"></i>' . $user['nama_pembeli'] . '</a>';
                    } else {
                        echo '
                    ...
                    <div class="lan-selector">
                        <select class="language_drop" name="countries" id="countries" style="width:300px;">
                            <option value='yt' data-image="<?= base_url('assets') ?>/img/flag-1.jpg" data-imagecss="flag yt" data-title="English">English</option>
                            <option value='yu' data-image="<?= base_url('assets') ?>/img/flag-2.jpg" data-imagecss="flag yu" data-title="Bangladesh">German </option>
                        </select>
                    </div>
