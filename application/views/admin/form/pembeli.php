<div class="col-md-4">
    <form action="<?= base_url('admin') ?>/create/pembeli" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" value="<?= set_value('email') ?>">
